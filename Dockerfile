# From https://raw.githubusercontent.com/MetaviewAI/docker-puppeteer/master/Dockerfile
...
# latest stable from https://en.wikipedia.org/wiki/Google_Chrome_version_history
...
# Install a new version of ffmpeg
# ubuntu ships with one 10+ years old...
RUN wget https://johnvansickle.com/ffmpeg/releases/ffmpeg-release-amd64-static.tar.xz
RUN tar -xf ffmpeg-release-amd64-static.tar.xz
RUN mv ffmpeg-6.0-amd64-static/ffmpeg /usr/local/bin/
RUN mv ffmpeg-6.0-amd64-static/ffprobe /usr/local/bin/
RUN rm ffmpeg-release-amd64-static.tar.xz
RUN rm -rfv ffmpeg-6.0-amd64-static
